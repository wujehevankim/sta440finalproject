...
\text{ }\text{ }\text{ }\text{ } The table below ranks the performance of three investment strategies—blind, fixed-effect, and mixed-effects—annually, with 1 indicating the best and 3 the worst, noting that ties are possible. Upon aggregating average ranks across our period of interest, the fixed-effects model boasts the superior average rank, securing the first place 13 times, outperforming the mixed-effects model's 10 top placements, and the blind strategy's 6. \newline
\begin{table}[H]
\centering
\begin{tabular}{cccc}
\hline
...
\text{ }\text{ }\text{ }\text{ } below is a table outlining for each year from our timeframe of interest, among the three strategies (blind, fixed-effect, and mixed-effects), which performed better (1 being best out hte three, 3 is worst, and note that there are ties) also, aggregating the simple average "rank", it seems that fixed effects had the best average rank. \newline
## V. Discussion
