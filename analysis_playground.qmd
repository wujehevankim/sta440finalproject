...
#summary(null_model)
full_modelOPEN <- glm(WasMondayOpenHigherThanFridayClose ~ didFridayCloseHigherThanThursdayClose + FridayCloseComparedToThursdayCloseChangeInPercent + wasFridayIntradayPositive + FridayIntradayChangeInPercent + fridayWasATripleWitchDay + NFPDayOrNot + NFPOutcome + CSIOutcome + CSIActualMinusExpected + CSIDayOrNot + wasItFOMCWeek + FOMCAction + FOMCActualVSExpected + FOMCActionSpecial + NFPOutcomeIsShock + CSIOutcomeIsShock + PrecedingWeekFridayVolumePrecedingWeekThursdayVolumeRATIO + FOMCActualVSExpected + FOMCActionSpecial + FridayVolumeMinusThursdayVolume + wasFridayOpenHigherThanThursdayClose, 
                  data = df8, family = binomial)
#summary(full_model)
...
null_modelCLOSE <- glm(WasMondayCloseHigherThanFridayClose ~ 1, 
                  data = df8, family = binomial)
#summary(null_model)
full_modelCLOSE <- glm(WasMondayOpenHigherThanFridayClose ~ didFridayCloseHigherThanThursdayClose + FridayCloseComparedToThursdayCloseChangeInPercent + wasFridayIntradayPositive + FridayIntradayChangeInPercent + fridayWasATripleWitchDay + NFPDayOrNot + NFPOutcome + CSIOutcome + CSIActualMinusExpected + CSIDayOrNot + wasItFOMCWeek + FOMCAction + FOMCActualVSExpected + FOMCActionSpecial + NFPOutcomeIsShock + CSIOutcomeIsShock + PrecedingWeekFridayVolumePrecedingWeekThursdayVolumeRATIO + FOMCActualVSExpected + FOMCActionSpecial+FridayVolumeMinusThursdayVolume + wasFridayOpenHigherThanThursdayClose, 
                  data = df8, family = binomial)
#summary(full_model)
