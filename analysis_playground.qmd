...
## COMPARING MondayOpenToFridayCloseRatio AND MondayCloseToFridayCloseRatio SIDE-BY-SIDE: BOXPLOT
```{r}
library(ggplot2)

# Assuming df4 is already loaded

# Plot for MondayOpenToFridayCloseRatio
plot1 <- ggplot(df4, aes(x = MondayOpenToFridayCloseRatio)) + 
    geom_boxplot(fill = "blue", alpha = 0.5) +
    labs(title = "Box Plot of Monday Open to Friday Close Ratio",
         x = "Monday Open to Friday Close Ratio",
         y = "Frequency")

# Plot for MondayCloseToFridayCloseRatio
plot2 <- ggplot(df4, aes(x = MondayCloseToFridayCloseRatio)) + 
    geom_boxplot(fill = "pink", alpha = 0.5) +
    labs(title = "Box Plot of Monday Close to Friday Close Ratio",
         x = "Monday Close to Friday Close Ratio",
         y = "Frequency")
