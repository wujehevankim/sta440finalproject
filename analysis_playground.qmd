...
library(knitr)
# Print the table
kable(breakdown_table, caption = "Proportion Breakdown of Monday Open and Close vs. Friday Close", format = "html")
...
write.csv(df8, file = "results/SPY_non_mixed_and_mixed_modelOPENandCLOSEpredicts20231218_0424pm_b.csv", row.names = FALSE)
